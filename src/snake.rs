...
impl Default for Snake {
    fn default() -> Self {
        let options = SnakeOptions {
            ...
            snake_size: 3,
            ghost_mode: true,
            first_snake_colour: 0xFF33CCFF,
            first_snake_head_colour: 0xFFCC66FF,
            second_snake_colour: 0xFFCC33FF,
            second_snake_head_colour: 0xFFFFCC00,
            food_colour: 0xFF66CC33,
            bad_berry_colour: 0xFFFF0000,
            points_to_reach: 15,
        };
        let cli = Cli {
            width: 80,
